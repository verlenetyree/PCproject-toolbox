...
class Toolbox(object):
    def __init__(self):
        ...
        self.tools = [proj_pryamaya_upd, proj_reverse_pryamaya]


class proj_pryamaya_upd(object):
    def __init__(self):
        """Define the tool (tool name is the name of the class)."""
        self.label = "proj_pryamaya_upd"
    ...
    def getParameterInfo(self):
        ...
        params = [in_layer, K, fik, out_layer]
        return params
            ...
            for part in feat:
                ...
                for pnt in feat.getPart(partnum):
                    if pnt:
                        x = pnt.X
                        y = pnt.Y
                        x = alpha*x*math.pi/180
                        if (K+math.cos(y*math.pi/180))==0:
                            continue
                        y = C*R*(math.sin(y*math.pi/180)/(K+math.cos(y*math.pi/180)))
...
class proj_reverse_pryamaya(object):
    def __init__(self):
        """Define the tool (tool name is the name of the class)."""
        self.label = "proj_reverse_pryamaya"
        self.description = "Perspective-cylindric projection"
        self.canRunInBackground = True
